...
func (s *FailoverState) HandleFailoverError(
	...
	// 站点级上游故障不在同账号重试，避免重复打到同一坏站点。
	if failoverErr.RetryableOnSameAccount && !service.IsUpstreamSiteLevelFailure(failoverErr.StatusCode) && s.SameAccountRetryCount[accountID] < retryLimit {
