...
func (s *accountRepoStubForAdminList) ListAllWithFilters(context.Context, AccountListFilters) ([]Account, error) {
	return nil, nil
}
...
func TestAdminService_ListAccounts_WithSearch(t *testing.T) {
	t.Run("search 参数正常传递到 repository 层", func(t *testing.T) {
		...
		accounts, total, err := svc.ListAccounts(context.Background(), 1, 20, AccountListFilters{
